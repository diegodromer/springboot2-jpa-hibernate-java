package com.diegolimadeoliveira.catalogo.config;
...
import com.diegolimadeoliveira.catalogo.entities.enums.OrderStatus;
import com.diegolimadeoliveira.catalogo.repositories.CategoryRepository;
import com.diegolimadeoliveira.catalogo.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2021-01-08T19:53:07Z"), OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2021-01-08T03:42:10Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2021-01-08T15:21:22Z"), OrderStatus.WAITING_PAYMENT, u1);
